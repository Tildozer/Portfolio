...
const Footer = () => {
  ...
  return (
    <div
      ref={footerContainer}
      className="fixed bottom-0 z-50 flex w-full items-center justify-center gap-1 border-t-2 border-t-slate-500 bg-slate-200 pb-4 pt-4 duration-500 dark:border-t-slate-600 dark:bg-blue-900 sm:gap-4"
    >
      <Link
