...
import rockSalt from "../../public/fonts/Rock Salt_Regular.json";
...
const Text = forwardRef<THREE.Group, Props>(({ settings }, ref) => {
  ...
  const fontData = {
    ...
    original_font_information: {
      ...rockSalt.original_font_information,
      format: rockSalt.original_font_information.format.toString(),
    },
  };
      ...
      <mesh material={holographicMaterial}>
        <textGeometry
          args={[
            ...
            { font, size: 0.75, height: 0.1, depth: 0.1 },
          ]}
        />
      </mesh>
      <mesh position={[0, -1, 0]} material={holographicMaterial}>
        <textGeometry
          args={[
            "until it's done.",
            { font, size: 0.75, height: 0.1, depth: 0.15 },
          ]}
        />
      </mesh>
    </group>
