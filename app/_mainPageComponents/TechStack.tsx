...
const TechStack = () => {
  ...
  return (
    <div className="mb-20">
      ...
      <div className="grid min-h-[9.25rem] w-full grid-flow-col grid-rows-3 content-start gap-2 self-center overflow-x-scroll border-2 border-l-0 border-r-0 border-solid border-slate-950 bg-orange-200 p-4 text-6xl text-yellow-500 transition-all duration-500 dark:bg-slate-900 dark:text-black">
        {techs.length
