...
const Header = () => {
  return (
    <>
      <div className="flex w-52 flex-col pb-6 text-orange-600 transition-all duration-500 dark:text-yellow-500 md:w-full md:flex-row md:justify-between md:text-lg">
        <ThemeSwitch />
        <Nav />
